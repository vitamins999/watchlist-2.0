const HomePage = () => {
  return (
    <section className='h-screen w-full bg-watchlistPortrait lg:bg-watchlist iPadPro:bg-watchlistPortrait iPadProWidescreen:bg-watchlistPortrait iPad:bg-watchlistPortrait iPadWidescreen:bg-watchlistPortrait bg-center bg-cover bg-no-repeat flex flex-row justify-end'>
      <div className='flex flex-col justify-center lg:items-end iPadProWidescreen:items-center xl:mr-16 2xl:mr-64 xs:-mt-0 -mt-28 iPadProWidescreen:mr-0'>
        <div className='flex flex-col justify-center items-center'>
          ...
          <p className='max-w-lg mt-10 text-sm lg:px-0 px-5 lg:text-base font-bodyWatchlist text-gray-900 text-center'>
            ...
            out what movies on an icheckmovies.com list are available for you to
            watch right now on Netflix and Amazon Prime Video.
          </p>
